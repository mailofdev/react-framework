...
const Topbar = ({
  ...
  const handleRouteClick = (item) => {
    ...
    setNavbarOpen(false); // Close navbar on nav click
  };
  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-dark bg-primary px-3 shadow-sm sticky-top fixed-top">
      <div className="container-fluid d-flex align-items-center justify-content-between flex-wrap">
        ...
        {/* Center Menu Items */}
        <div
          className={`navbar-collapse collapse flex-grow-1${navbarOpen ? ' show' : ''}`}
          id="navbarContent"
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <button type="button" className="btn-close" aria-label="Close" onClick={handleLogoutCancel}></button>
              </div>
              ...
              <div className="modal-footer">
                ...
                <button type="button" className="btn btn-danger" onClick={handleLogoutConfirm}>Logout</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          ...
          <div className="modal-body text-center">
            <img src={user.avatar} alt="avatar" className="rounded-circle mb-3" width="80" height="80" />
            <h6>{user.name}</h6>
